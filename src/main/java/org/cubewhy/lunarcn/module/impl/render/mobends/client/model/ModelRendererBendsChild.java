...
public class ModelRendererBendsChild extends ModelRendererBends{
	...
	public ModelRendererBendsChild(ModelBase argModel) {
		super(argModel);
	}
	
	public ModelRendererBendsChild(ModelBase argModel, String argName)
    {
		super(argModel, argName);
    }
	
	public ModelRendererBendsChild(ModelBase argModel, int argTexOffsetX, int argTexOffsetY)
    {
        super(argModel,argTexOffsetX,argTexOffsetY);
    }
    
	public ModelRendererBendsChild setMother(ModelRendererBends argMom){
