...
import org.cubewhy.lunarcn.module.impl.render.mobends.client.model.ModelRendererBendsSeperatedChild;
...
public class ModelBendsPlayer extends ModelPlayer {
    ...
    public ModelBendsPlayer(float scaleFactor, boolean useSmallArms, boolean bigTexture) {
        ...
        if (useSmallArms)
        {
            this.bipedLeftArm = new ModelRendererBendsSeperatedChild(this, 32, 48).setMother((ModelRendererBends) this.bipedBody).setShowChildIfHidden(true);
            this.bipedLeftArm.addBox(-1.0F, -2.0F, -2.0F, 3, 6, 4, scaleFactor);
            this.bipedLeftArm.setRotationPoint(5.0F, 2.5F-12.0f, 0.0F);
            this.bipedRightArm = new ModelRendererBendsSeperatedChild(this, 40, 16).setMother((ModelRendererBends) this.bipedBody).setShowChildIfHidden(true);
        ...
        */
        ...
        ((ModelRendererBendsSeperatedChild)this.bipedRightArm).setSeperatedPart(this.bipedRightForeArm);
        ((ModelRendererBendsSeperatedChild)this.bipedLeftArm).setSeperatedPart(this.bipedLeftForeArm);
    ...
    public void setRotationAngles(float argSwingTime, float argSwingAmount, float argArmSway, float argHeadY, float argHeadX, float argNr6, Entity argEntity)
    {
        ...
        PlayerData data = PlayerData.get(argEntity.getEntityId());
        ...
        if (PlayerData.get(argEntity.getEntityId()).canBeUpdated()) {
            ...
            BendsVar.tempData = PlayerData.get(argEntity.getEntityId());

            if ( argEntity.isRiding()) {
                animatedEntity.get("riding").animate((EntityLivingBase)argEntity, this, PlayerData.get(argEntity.getEntityId()));
                BendsPack.animate(this,"player","riding");
            } else {
                if (argEntity.isInWater()) {
                    animatedEntity.get("swimming").animate((EntityLivingBase)argEntity, this, PlayerData.get(argEntity.getEntityId()));
                    BendsPack.animate(this,"player","swimming");
                } else {
                    if (!PlayerData.get(argEntity.getEntityId()).isOnGround() | PlayerData.get(argEntity.getEntityId()).ticksAfterTouchdown < 2) {
                        animatedEntity.get("jump").animate((EntityLivingBase)argEntity, this, PlayerData.get(argEntity.getEntityId()));
                        BendsPack.animate(this,"player","jump");
                    } else {
                        if (PlayerData.get(argEntity.getEntityId()).motion.x == 0.0f & PlayerData.get(argEntity.getEntityId()).motion.z == 0.0f) {
                            animatedEntity.get("stand").animate((EntityLivingBase)argEntity, this, PlayerData.get(argEntity.getEntityId()));
                            BendsPack.animate(this,"player","stand");
                        } else {
                            if (argEntity.isSprinting()) {
                                animatedEntity.get("sprint").animate((EntityLivingBase)argEntity, this, PlayerData.get(argEntity.getEntityId()));
                                BendsPack.animate(this,"player","sprint");
                            } else {
                                animatedEntity.get("walk").animate((EntityLivingBase)argEntity, this, PlayerData.get(argEntity.getEntityId()));
                                BendsPack.animate(this,"player","walk");
                            }
                        }

                        if (argEntity.isSneaking()) {
                            animatedEntity.get("sneak").animate((EntityLivingBase)argEntity, this, PlayerData.get(argEntity.getEntityId()));
            ...
            if (this.aimedBow) {
                animatedEntity.get("bow").animate((EntityLivingBase)argEntity, this, PlayerData.get(argEntity.getEntityId()));
                ...
                if (/*(currentItem != null && currentItem.getItem() instanceof ItemPickaxe) ||
                    ...
                    animatedEntity.get("mining").animate((EntityLivingBase)argEntity, this, PlayerData.get(argEntity.getEntityId()));
                    BendsPack.animate(this,"player","mining");
                } else if (currentItem != null && currentItem.getItem() instanceof ItemAxe) {
                    animatedEntity.get("axe").animate((EntityLivingBase)argEntity, this, PlayerData.get(argEntity.getEntityId()));
                    BendsPack.animate(this,"player","axe");
                } else {
                    animatedEntity.get("attack").animate((EntityLivingBase)argEntity, this, PlayerData.get(argEntity.getEntityId()));
                }
            }
        ...
        PlayerData.get(argEntity.getEntityId()).syncModelInfo(this);
    }
    ...
    public void updateWithEntityData(AbstractClientPlayer argPlayer) {
        PlayerData data = PlayerData.get(argPlayer.getEntityId());
        if (data != null) {
            this.renderOffset.set(data.renderOffset);
            this.renderRotation.set(data.renderRotation);
            this.renderItemRotation.set(data.renderItemRotation);
