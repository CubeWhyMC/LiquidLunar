...
public class ModelRendererBendsSeperatedChild extends ModelRendererBends{
	ModelRendererBends momModel;
	ModelRendererBends seperatedModel;
	
	public ModelRendererBendsSeperatedChild(ModelBase argModel) {
		super(argModel);
	}
	
	public ModelRendererBendsSeperatedChild(ModelBase argModel, String argName)
    {
		super(argModel, argName);
    }
	
	public ModelRendererBendsSeperatedChild(ModelBase argModel, int argTexOffsetX, int argTexOffsetY)
    {
        super(argModel,argTexOffsetX,argTexOffsetY);
    }
    
	public ModelRendererBendsSeperatedChild setMother(ModelRendererBends argMom){
		this.momModel = argMom;
		return this;
	}
	
	public ModelRendererBendsSeperatedChild setSeperatedPart(ModelRendererBends argPart){
