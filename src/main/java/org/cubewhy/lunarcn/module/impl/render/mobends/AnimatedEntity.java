...
import org.cubewhy.lunarcn.module.impl.render.mobends.animation.zombie.AnimationStand;
import org.cubewhy.lunarcn.module.impl.render.mobends.animation.zombie.AnimationWalk;
...
public class AnimatedEntity {
	...
	public static void register() {
		...
		registerEntity(new AnimatedEntity("zombie","Zombie",new EntityZombie(null),EntityZombie.class,new RenderBendsZombie(Minecraft.getMinecraft().getRenderManager())).
			add(new AnimationStand()).
			add(new AnimationWalk()));
