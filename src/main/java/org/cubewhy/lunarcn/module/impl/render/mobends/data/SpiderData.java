...
public class SpiderData extends EntityData{
	public static List<SpiderData> dataList = new ArrayList<SpiderData>();
	...
	public SpiderData(int argEntityID) {
		super(argEntityID);
	}
	...
	public static void add(SpiderData argData){
		dataList.add((SpiderData) argData);
	}
	
	public static SpiderData get(int argEntityID){
		...
		SpiderData newData = new SpiderData(argEntityID);
		
		if(Minecraft.getMinecraft().theWorld.getEntityByID(argEntityID) != null){
			dataList.add((SpiderData) newData);
		}
